                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12 mt-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="transport_type" value="open" required
                                                checked>
                                            <label class="form-check-label">Open</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="transport_type" value="enclosed"
                                                required>
