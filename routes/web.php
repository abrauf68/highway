...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware(['check.activation'])->group(function () {
        ...
        Route::prefix('dashboard')->name('dashboard.')->group(function () {
            ...
            Route::post('quotes/status/update', [QuoteController::class, 'updateStatus'])->name('quotes.status.update');
            ...
            Route::get('faqs/status/{id}', [FAQController::class, 'updateStatus'])->name('faqs.status.update');

            // Team
            Route::resource('team', TeamController::class);
            Route::get('team/status/{id}', [TeamController::class, 'updateStatus'])->name('team.status.update');
...
Route::name('frontend.')->group(function () {
    ...
    Route::post('contact/submit', [FormSubmissionController::class, 'submitContactForm'])->name('contact.submit');
